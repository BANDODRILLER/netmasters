...
{{--            </a>--}}
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
                <div class="w-full overflow-x-auto"><table style="border: none" class="min-w-full divide-y divide-gray-200" loading="lazy" id="responsive-table">
                        <thead>
                        <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                            <th class="px-4 py-3">Day/Time</th>
                            <th class="px-4 py-3">Game</th>
                            <th class="px-4 py-3">Half Time Score</th>
                            <th class="px-4 py-3">Probability in %</th>
                            <th class="px-4 py-3">1</th>
                            <th class="px-4 py-3">X</th>
                            <th class="px-4 py-3">2</th>
                            <th class="px-4 py-3">Pred HT</th>
                            <th class="px-4 py-3">Pred FT</th>
                        ...
                        @foreach($table->take(6) as $t)
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="border-r">1-1</td>
                                <td class="border-r">2-1</td>
                                <td class="border-r hide-on-mobile">{{$t->score}}</td>
                                <td class="border-r hide-on-mobile">{{$t->tip}}</td>
