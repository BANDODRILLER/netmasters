                ...
                <div class="w-full overflow-x-auto">
                    <table style="border: none" class="min-w-full divide-y divide-gray-200" loading="lazy" id="responsive-table">
                        ...
                        <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                            ...
                            <th class="px-4 py-3"> % Under 9.5</th>
                            <th class="px-4 py-3"> % Over 9.5</th>
                            <th class="px-4 py-3">Pred</th>
                            <th class="px-4 py-3">Avg. corners</th>
                            <th class="px-4 py-3">Weather conditions</th>
                            <th class="px-4 py-3">Coef.</th>
                            <th class="px-4 py-3">Corners</th>
                        </tr>
                        </thead>
                        ...
                        @foreach($table->take(6) as $t)
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="border-r">{{$t->under_over_9_5}}</td>
                                <td class="border-r">{{$t->under_over_9_5}}</td>
                                <td class="border-r">{{$t->pred}}</td>
                                <td class="border-r hide-on-mobile">12.8</td>
